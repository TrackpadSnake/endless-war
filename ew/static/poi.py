...
poi_list = [
	EwPoi(
		...
		is_district = True,
		is_capturable = True,
		neighbors = {'krakbay': 60, 'smogsburg': 60, 'poudrinalley': 60, 'rowdyroughhouse': 60, 'copkilltown': 60, 'greenlightdistrict': 60, 'theslimestockexchange': 20, 'endlesswar': 20, 'slimecorphq': 20, 'downtownsubwaystation': 20, 'limecorp1f': 20},
	...
	EwPoi(
		...
		is_district = True,
		is_capturable = True,
		neighbors = {'southsleezeborough': 60, 'krakbay': 60, 'poudrinalley': 60, 'cratersville': 60, 'oozegardensfarms': 20, 'southoutskirtsedge': 120, 'themuseum': 20},
	...
	EwPoi(
		...
		str_desc = "Limecorp Floor 2 hasn't been looted quite so thoroughly yet. Most people are afraid to come up here; since this building has no foundation it would probably tip over pretty easily. More knocked-over cubicles and Windows 7 licenses for you then! It's a tragedy, but since Slimecorp more or less died, most of these scattered documents aren't valuable anymore. And you're not about to lawyer up and find the ones that are. Maybe you can **sift** through the papers and wreckage and do some office work? Nah, that's stupid. \n\nLimecorp 1F is below, and Limecorp 3F is above you.",
		channel = "limecorp-2f",
		major_role = "nullmajorrole",
		minor_role = "nullminorrole",
